...
public class DataGrid
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DataWidgets.DataGrid"));
	}
	...
	protected DataGrid(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject dataGridMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DataWidgets.DataGrid", dataGridMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DataWidgets.DataGrid");
	...
	public static datawidgets.proxies.DataGrid initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return datawidgets.proxies.DataGrid.load(context, mendixIdentifier);
	}
	...
	{
		java.util.List<datawidgets.proxies.DataGrid> result = new java.util.ArrayList<datawidgets.proxies.DataGrid>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//DataWidgets.DataGrid" + xpathConstraint))
			result.add(datawidgets.proxies.DataGrid.initialize(context, obj));
		return result;
	}
